...
using ParichayLite.Models.Extensions;
...
namespace ParichayLite.Models.Providers
{
    public sealed class AuthorizationProvider : OpenIdConnectServerProvider
    {
        ...
        public async Task ValidateTokenRequest(ValidateTokenRequestContext context)
        {
        ...
        public  async Task ValidateLogoutRequest(ValidateLogoutRequestContext context)
        {
            var database = context.HttpContext.RequestServices.GetRequiredService<ApplicationContext>();
